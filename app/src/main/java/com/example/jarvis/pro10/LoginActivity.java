...
public class LoginActivity extends AppCompatActivity  {
    ...
    private String usnm="manager";
    private String pass="manager1234";
...
*/
        Button b1=(Button) findViewById(R.id.email_sign_in_button);
        b1.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      final EditText paswd=(EditText)findViewById(R.id.password);
                                      if(!email.getText().toString().isEmpty()&&!paswd.getText().toString().isEmpty())
                                      {

                                          if (usnm.equals(email.getText().toString()) && pass.equals(paswd.getText().toString()))
                                          {
                                              Toast.makeText(getApplicationContext(), "You have successfully logged in", Toast.LENGTH_SHORT).show();

                                          }
                                          else if(!usnm.equals(email.getText().toString()) && pass.equals(paswd.getText().toString()))
                                          {
                                      ...
                                      else if(email.getText().toString().isEmpty()&&!paswd.getText().toString().isEmpty())
                                      {
